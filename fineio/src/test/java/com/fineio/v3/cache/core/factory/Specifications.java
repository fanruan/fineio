...
public final class Specifications {
    public static final String CORE_PACKAGE_NAME = "com.fineio.v3.cache.core";
    public static final String FACTORY_PACKAGE_NAME = "com.fineio.v3.cache.core.factory";
    ...
    public static final ClassName nodeType = ClassName.get(CORE_PACKAGE_NAME, "Node");
    public static final TypeName lookupKeyType =
            ClassName.get(CORE_PACKAGE_NAME + ".References", "LookupKeyReference");
    public static final TypeName referenceKeyType = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME + ".References", "WeakKeyReference"), kTypeVar);
    public static final TypeName rawReferenceKeyType = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME + ".References", "WeakKeyReference"), ClassName.get(Object.class));
    ...
    public static final TypeName UNSAFE_ACCESS =
            ClassName.get("com.fineio.v3.cache.base", "UnsafeAccess");

    public static final TypeName LOCAL_CACHE_FACTORY =
            ClassName.get(FACTORY_PACKAGE_NAME, "LocalCacheFactory");
    public static final ParameterizedTypeName NODE_FACTORY = ParameterizedTypeName.get(
            ClassName.get(FACTORY_PACKAGE_NAME, "NodeFactory"), kTypeVar, vTypeVar);
    public static final ClassName BUILDER = ClassName.get(CORE_PACKAGE_NAME, "Caffeine");
    ...
    public static final ParameterizedTypeName BOUNDED_LOCAL_CACHE = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME, "BoundedLocalCache"), kTypeVar, vTypeVar);
    ...
    public static final ParameterizedTypeName CACHE_LOADER = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME, "CacheLoader"), TypeVariableName.get("? super K"), vTypeVar);
    ...
    public static final TypeName REMOVAL_LISTENER = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME, "RemovalListener"), kTypeVar, vTypeVar);

    public static final TypeName STATS_COUNTER =
            ClassName.get(CORE_PACKAGE_NAME + ".stats", "StatsCounter");
    public static final TypeName TICKER = ClassName.get(CORE_PACKAGE_NAME, "Ticker");

    public static final TypeName ACCESS_ORDER_DEQUE =
            ParameterizedTypeName.get(ClassName.get(CORE_PACKAGE_NAME, "AccessOrderDeque"), NODE);
    public static final TypeName WRITE_ORDER_DEQUE =
            ParameterizedTypeName.get(ClassName.get(CORE_PACKAGE_NAME, "WriteOrderDeque"), NODE);

    public static final ClassName WRITE_QUEUE_TYPE =
            ClassName.get(CORE_PACKAGE_NAME, "MpscGrowableArrayQueue");
    ...
    public static final TypeName EXPIRY = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME, "Expiry"), kTypeVar, vTypeVar);
    public static final TypeName TIMER_WHEEL = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME, "TimerWheel"), kTypeVar, vTypeVar);

    public static final TypeName FREQUENCY_SKETCH = ParameterizedTypeName.get(
            ClassName.get(CORE_PACKAGE_NAME, "FrequencySketch"), kTypeVar);
