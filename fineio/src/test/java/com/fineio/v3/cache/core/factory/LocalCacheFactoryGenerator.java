...
import com.fineio.v3.cache.core.factory.local.AddConstructor;
import com.fineio.v3.cache.core.factory.local.AddDeques;
import com.fineio.v3.cache.core.factory.local.AddExpirationTicker;
import com.fineio.v3.cache.core.factory.local.AddExpireAfterAccess;
import com.fineio.v3.cache.core.factory.local.AddExpireAfterWrite;
import com.fineio.v3.cache.core.factory.local.AddFastPath;
import com.fineio.v3.cache.core.factory.local.AddKeyValueStrength;
import com.fineio.v3.cache.core.factory.local.AddMaximum;
import com.fineio.v3.cache.core.factory.local.AddRefreshAfterWrite;
import com.fineio.v3.cache.core.factory.local.AddRemovalListener;
import com.fineio.v3.cache.core.factory.local.AddStats;
import com.fineio.v3.cache.core.factory.local.AddSubtype;
import com.fineio.v3.cache.core.factory.local.AddWriteBuffer;
import com.fineio.v3.cache.core.factory.local.Finalize;
import com.fineio.v3.cache.core.factory.local.LocalCacheContext;
import com.fineio.v3.cache.core.factory.local.LocalCacheRule;
...
import static com.fineio.v3.cache.core.factory.Specifications.BOUNDED_LOCAL_CACHE;
import static com.fineio.v3.cache.core.factory.Specifications.BUILDER_PARAM;
import static com.fineio.v3.cache.core.factory.Specifications.CACHE_LOADER_PARAM;
...
public final class LocalCacheFactoryGenerator {
    ...
    public static void main(String[] args) throws IOException {
        new LocalCacheFactoryGenerator(Paths.get("G:/factory")).generate();
    }
    ...
    private void addFactoryMethods() {
        factory.addMethod(MethodSpec.methodBuilder("newBoundedLocalCache")
                ...
                .addParameter(CACHE_LOADER_PARAM.toBuilder().build())
