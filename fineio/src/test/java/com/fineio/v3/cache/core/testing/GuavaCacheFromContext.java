...
import com.fineio.v3.cache.core.Policy;
...
public final class GuavaCacheFromContext {
    ...
    static final class GuavaWeigher<K, V> implements Weigher<K, V>, Serializable {
        ...
        final com.fineio.v3.cache.core.Weigher<K, V> weigher;

        GuavaWeigher(com.fineio.v3.cache.core.Weigher<K, V> weigher) {
    ...
    static final class GuavaRemovalListener<K, V> implements RemovalListener<K, V>, Serializable {
        ...
        final com.fineio.v3.cache.core.RemovalListener<K, V> delegate;
        final boolean translateZeroExpire;

        GuavaRemovalListener(boolean translateZeroExpire,
                             com.fineio.v3.cache.core.RemovalListener<K, V> delegate) {
    ...
    static class SingleLoader<K, V> extends CacheLoader<K, V> implements Serializable {
        ...
        final com.fineio.v3.cache.core.CacheLoader<K, V> delegate;

        SingleLoader(com.fineio.v3.cache.core.CacheLoader<K, V> delegate) {
            this.delegate = delegate;
        }
    ...
    static class BulkLoader<K, V> extends SingleLoader<K, V> {
        ...
        BulkLoader(com.fineio.v3.cache.core.CacheLoader<K, V> delegate) {
            super(delegate);
        }
