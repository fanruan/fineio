...
import static com.fineio.v3.cache.core.factory.Specifications.CORE_PACKAGE_NAME;
...
public abstract class NodeRule implements Consumer<NodeContext> {
    ...
    protected TypeName valueReferenceType() {
        ...
        String clazz = context.generateFeatures.contains(Feature.WEAK_VALUES)
                ? "WeakValueReference"
                : "SoftValueReference";
        return ParameterizedTypeName.get(ClassName.get(CORE_PACKAGE_NAME + ".References", clazz), vTypeVar);
    }
