...
//        };
        ...
        IOFileV2 file = FineIO.createIOFile(mockConnector, u, FineIO.MODEL.APPEND_BYTE);
    ...
    public void testAppendDouble() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_DOUBLE);
        for (int i = 0; i < doubles.length; i++) {
        ...
        read.close();
        IOFileV2 edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_DOUBLE);
    ...
    public void testAppendLong() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_LONG);
        for (int i = 0; i < values.length; i++) {
        ...
        System.out.println((System.currentTimeMillis() - t) + " ms");
        read.close();
        IOFileV2<LongBuffer> edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_LONG);
    ...
    public void testAppendChar() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_CHAR);
        for (int i = 0; i < values.length; i++) {
        ...
        System.out.println((System.currentTimeMillis() - t) + " ms");
        read.close();
        IOFileV2<CharBuffer> edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_CHAR);
        int change = values.length / 2;
    ...
    public void testAppendInt() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_INT);
        for (int i = 0; i < values.length; i++) {
        ...
        System.out.println((System.currentTimeMillis() - t) + " ms");
        read.close();
        IOFileV2<IntBuffer> edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_INT);
        int change = values.length / 2;
    ...
    public void testAppendFloat() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_FLOAT);
        for (int i = 0; i < values.length; i++) {
        ...
        System.out.println((System.currentTimeMillis() - t) + " ms");
        read.close();
        IOFileV2<FloatBuffer> edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_FLOAT);
        int change = values.length / 2;
    ...
    public void testAppendShort() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_SHORT);
        for (int i = 0; i < values.length; i++) {
        ...
        System.out.println((System.currentTimeMillis() - t) + " ms");
        read.close();
        IOFileV2<ShortBuffer> edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_SHORT);
        int change = values.length / 2;
    ...
    public void testAppendByte() throws Exception {
        ...
        file.close();
        IOFileV2 read = FineIO.createIOFile(connector, u, FineIO.MODEL.READ_BYTE);
        for (int i = 0; i < values.length; i++) {
        ...
        System.out.println((System.currentTimeMillis() - t) + " ms");
        read.close();
        IOFileV2<ByteBuffer> edit = FineIO.createIOFile(connector, u, FineIO.MODEL.APPEND_BYTE);
        int change = values.length / 2;
