...
import com.fineio.v3.cache.core.factory.node.AddConstructors;
import com.fineio.v3.cache.core.factory.node.AddDeques;
import com.fineio.v3.cache.core.factory.node.AddExpiration;
import com.fineio.v3.cache.core.factory.node.AddFactoryMethods;
import com.fineio.v3.cache.core.factory.node.AddHealth;
import com.fineio.v3.cache.core.factory.node.AddKey;
import com.fineio.v3.cache.core.factory.node.AddMaximum;
import com.fineio.v3.cache.core.factory.node.AddSubtype;
import com.fineio.v3.cache.core.factory.node.AddValue;
import com.fineio.v3.cache.core.factory.node.Finalize;
import com.fineio.v3.cache.core.factory.node.NodeContext;
import com.fineio.v3.cache.core.factory.node.NodeRule;
...
import static com.fineio.v3.cache.core.factory.Specifications.BUILDER_PARAM;
import static com.fineio.v3.cache.core.factory.Specifications.DEAD_STRONG_KEY;
import static com.fineio.v3.cache.core.factory.Specifications.DEAD_WEAK_KEY;
import static com.fineio.v3.cache.core.factory.Specifications.FACTORY_PACKAGE_NAME;
import static com.fineio.v3.cache.core.factory.Specifications.NODE;
import static com.fineio.v3.cache.core.factory.Specifications.NODE_FACTORY;
import static com.fineio.v3.cache.core.factory.Specifications.RETIRED_STRONG_KEY;
import static com.fineio.v3.cache.core.factory.Specifications.RETIRED_WEAK_KEY;
...
import static com.fineio.v3.cache.core.factory.Specifications.rawReferenceKeyType;
...
public final class NodeFactoryGenerator {
    ...
    private TypeSpec makeNodeSpec(String className, boolean isFinal, Set<Feature> features) {
        ...
        if (features.size() == 2) {
            ...
            superClass = ParameterizedTypeName.get(ClassName.get(FACTORY_PACKAGE_NAME,
    ...
    public static void main(String[] args) throws IOException {
        new NodeFactoryGenerator(Paths.get("G:/factory")).generate();
    }
}
