 ...
 * @date 2019/9/12
 */
public class IntAppendIOFile extends AppendIOFile<ByteUnsafeBuf> {
    protected IntAppendIOFile(Connector connector, URI uri) {
    ...
    protected UnsafeBuf createBuf(int idx) {
        return BaseUnsafeBuf.newBuffer(new BufferKey(connector, new FileBlock(uri, String.valueOf(idx)))).asInt();
    }
}
