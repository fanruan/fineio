 ...
 * @date 2019/9/12
 */
public class ByteAppendIOFile extends AppendIOFile<ByteUnsafeBuf> {
    protected ByteAppendIOFile(Connector connector, URI uri) {
    ...
    protected UnsafeBuf createBuf(int idx) {
        return BaseUnsafeBuf.newBuffer(new BufferKey(connector, new FileBlock(uri, String.valueOf(idx))));
    }
}
