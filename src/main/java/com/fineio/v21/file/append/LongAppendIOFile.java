package com.fineio.v21.file.append;
 ...
 * @date 2019/9/12
 */
public class LongAppendIOFile extends AppendIOFile<ByteUnsafeBuf> {
    protected LongAppendIOFile(Connector connector, URI uri) {
        super(connector, uri, (byte) MemoryConstants.OFFSET_LONG);
    }
    ...
    protected UnsafeBuf createBuf(int idx) {
        return BaseUnsafeBuf.newBuffer(new BufferKey(connector, new FileBlock(uri, String.valueOf(idx)))).asLong();
    }
}
