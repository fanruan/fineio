...
import com.fineio.v3.cache.core.Async.AsyncRemovalListener;
import com.fineio.v3.cache.core.Async.AsyncWeigher;
import com.fineio.v3.cache.core.stats.CacheStats;
import com.fineio.v3.cache.core.stats.ConcurrentStatsCounter;
...
public final class Caffeine<K, V> {
    ...
    Expiry<? extends K, ? extends V> expiry;
    Executor executor;
    Ticker ticker;
    ...
    public <K1 extends K, V1 extends V> Caffeine<K1, V1> expireAfter(
            Expiry<? extends K1, ? extends V1> expiry) {
