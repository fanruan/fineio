 ...
 * @date 2019/9/12
 */
public class LongAppendIOFile extends AppendIOFile<ByteBuffer> {
    public LongAppendIOFile(Connector connector, URI uri) {
    ...
    protected Buffer createBuf(int idx) {
        return BaseBuffer.newAppendBuffer(new BufferKey(connector, new FileBlock(uri, String.valueOf(idx)))).asLong();
    }
}
